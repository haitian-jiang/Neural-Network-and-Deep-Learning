...
class VGG_A_Light_BN(nn.Module):
    def __init__(self, inp_ch=3, num_classes=10, bn=False):
        super().__init__()
...
class VGG_A_Dropout_BN(nn.Module):
...
if __name__ == '__main__':
    ...
    print(get_number_of_parameters(VGG_A_Light_BN()))
    print(get_number_of_parameters(VGG_A_Dropout_BN()))